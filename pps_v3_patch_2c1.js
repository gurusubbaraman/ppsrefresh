...
(function () {
  ...
  function iconHtml(slug) {
    ...
    return '<span class="pps-cat-ico">' + ic + '</span>';
  }
  ...
  function injectCss() {
    ...
    var css = ''
      ...
      /* category icons (Session 2C.2) */
      + '.pps-cat-ico{display:inline-block;margin-right:5px;font-size:1.42em;line-height:1;'
      + 'vertical-align:-.22em;font-family:"Apple Color Emoji","Segoe UI Emoji","Noto Color Emoji",sans-serif}'
      + '.pps-cat-ico-img{width:19px;height:19px;margin-right:5px;vertical-align:-.34em;'
      + 'display:inline-block;flex:0 0 auto;image-rendering:auto}'
      + '.pps-legend-row{align-items:center}'
      + '.pps-legend-row .pps-cat-ico{font-size:1.25em;margin-right:4px}'
      + '.pps-legend-row .pps-cat-ico-img{width:16px;height:16px;margin-right:4px}'
      + '.pps-tip-sets{display:inline-block;margin-top:3px;line-height:1}'
      + '.pps-tip-sets .pps-cat-ico{font-size:1.15em;margin-right:2px}'
      + '.pps-tip-sets .pps-cat-ico-img{width:15px;height:15px;margin-right:2px}'
