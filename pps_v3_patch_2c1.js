...
/*   4) Color driver = 7 canonical category sets; multi-select        */
...
/*  B: Maada Koil intentionally excluded (0 temples tagged in data).  */
...
(function () {
  ...
  console.log('[Session 2C.1] Loading category map UX...');
